...
public class TimeZoneTranslatorTest {
	...
	public void testShiftTimeZone() {
		...
		assertEquals("2018-08-27 09:00:00", LectureStart.toString());
	}

	@Test
	public void testShiftEventTimeZone() {
		
		DateTime SchoolStart = new DateTime(2018, 8, 27, 8, 0, 0);
		DateTime SchoolEnds = new DateTime(2018, 8, 27, 16, 45, 0);
		...
		assertEquals("2018-08-27 09:00:00", school.getStartDate().toString());
		assertEquals("2018-08-27 17:45:00", school.getEndDate().toString());
	}
	...
	public void testShiftTimeZone2()
	{
		...
		assertEquals("2015-12-31 21:00:00",date2.toString());
	}
